void calc_GCpattern_theta_gain_DS(struct presyn_2pools W[], arma::mat& MFpatterns, arma::mat& GCpatterns, double theta[], double GCgain[], double& Tavrg, double& Gavrg, double& hGCavrg, double& hGCvar, double& CLavrg, struct netpara NETPARA, struct flags FLAGS, gsl_rng * r) {
